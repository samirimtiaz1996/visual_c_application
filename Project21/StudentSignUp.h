...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Enter += gcnew System::EventHandler(this, &StudentSignUp::groupBox1_Enter);
			// 
			// label6
			// 
			...
			this->email_txt->TextChanged += gcnew System::EventHandler(this, &StudentSignUp::email_txt_TextChanged);
			// 
			// age_txt
			// 
			...
			this->Load += gcnew System::EventHandler(this, &StudentSignUp::StudentSignUp_Load);
...
#pragma endregion
	...
	private: System::Void StudentSignUp_Load(System::Object^  sender, System::EventArgs^  e) {
	}
